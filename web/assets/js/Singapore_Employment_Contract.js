 ...
 * 2022-09-20 | jjucutan | added dynamic section numbering
 */
...
const fnView = function() {
    ...
    $("#markup").html("").append(
        ...
        $('<div class="offerClause"/>').append(
            $('<label/>').append(
                $('<strong/>').append(
                    sectionNumbering({ incrementSection: true }).section,
                    '. <u>Appointment </u>'
                )
            ),
        ...
        $('<div class="offerClause"/>').append(
            $('<label/>').append(
                ...
                '. <u>Conduct and Discipline</u>'
            ),
            $('<ul/>').append(
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                ...
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' During your employment, your duties and responsibilities shall include (but not in any way be restricted to): '
                ),
                $('<ul/>').append(
                    $('<p/>').append(
                ...
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' You shall not, during your employment with the Company, continue, accept, commence or engage in any other employment or paid or unpaid consulting positions without the prior written approval from the Company (which may be withheld by the Company at its sole discretion).'
                ),
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
        ...
        $('<div class="offerClause"/>').append(
            ...
            $('<ul/>').append(
                $('<p/>').append(
                    ...
                    ' per month), subject to all deductions required or authorized to be deducted by the Company, payable monthly in arrears (or such other amounts as may from time to time be agreed in writing) over 12 months. Your basic salary shall be subject to an annual review in accordance with Company policy, at the sole discretion of the Company. Your remuneration under this Agreement is confidential and should not be disclosed to any member of staff.'),
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' In respect of any payment and benefits to you hereunder, the Company and you (as employer and employee, respectively) shall, where applicable, comply with the provisions of the Central Provident Fund Act (Chapter 36) (the "CPF Act") for the time being in force and the rules and regulations promulgated thereunder. Unless you are or become a Singapore Permanent Resident or a Singapore Citizen, you will not be eligible for contributions under the CPF Act.'),
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' You will be solely responsible for all taxes which may be payable in respect of any remuneration due to you and for the declaration of your remuneration to the relevant tax authorities. You agree to forthwith indemnify the Company against any claims for tax in respect of any such remuneration. Where applicable, the Company shall be entitled to withhold payment of any sums due to you for tax clearance purposes.'),
                (employee.paymentAmount1 > 0) &&
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' In addition, as agreed PayPal will provide a one off Make Good Payments of $',
                    $('<mark/>').text(employee.paymentAmount1),
                    ' (SGD). The Make Good Payments letter is attached and this amount will be paid in the first pay period after the commencement with PayPal. This is subject to all standard employment related taxes applicable in Singapore'),
...
' ',
                ...
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' In addition, PayPal will provide a monthly housing allowance of  ',
                    $('<mark/>').append(
...
' ',
        ...
        $('<div class="offerClause AIPContainer"/>').append(
            $('<label/>').append(
                ...
                '. <u>Bonus Eligibility </u>'),
            (employee.AIP == 'Yes') &&
            $('<ul class="marked" data-toggle="popover" data-placement="top" data-content="Qualifies for Annual Incentive Plan (AIP)"/>').append(
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' You will be eligible to participate in a PayPal Annual Incentive Plan for a specified fiscal year (“',
                    $('<strong/>').text('AIP'),
        ...
        $('<div class="offerClause"/>').append(
            $('<label/>').append(
                ...
                '. <u>Expenses</u>'),
            $('<p/>').html('The Company shall reimburse you in respect of such expenses as may be properly and reasonably incurred by you while engaged in the business of the Company in accordance with the Company\'s prevailing expenses reimbursement policy.'),
            $('<p class="hide"/>').html('<br>')
        ),
        $('<div class="offerClause"/>').append(
            $('<label/>').append(
        ...
        $('<div class="offerClause"/>').append(
            $('<label/>').append(
                ...
                '. <u>Illness, injury and leave</u>'),
            $('<ul/>').append(
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' In the event of any illness or injury incapacitating you from attending to your duties, you shall be entitled to be absent from duties by taking up either the relevant sick leave entitlement or hospitalization leave entitlement in accordance with Singapore law, provided that such leave entitlement can only be taken upon certification by a medical practitioner.'),
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' You will be entitled to at least the maternity, paternity, childcare and infant care leave entitlements which you are eligible for under Singapore law. More generous entitlements may be provided pursuant to a Company policy in place from time to time.'),
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' Subject to the rules and procedures established by the Company from time to time, all employees shall be entitled to medical benefits in accordance with the Company\'s prevailing benefits policy.'),
                // reset subsection numbering
                true && sectionNumbering({ resetSubSection: true }),
            ),
            $('<p class="hide"/>').html('<br>')
        ...
        $('<div class="offerClause"/>').append(
            ...
            $('<ul/>').append(
                ...
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' The restrictions contained in this clause 13 shall not apply:'),
                $('<ul/>').append(
                    $('<p/>').append(
                ...
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' You acknowledge that the restrictions contained in this clause 13 are reasonable and that irreparable damage will be caused to the Company in the event of any violation of any of the provisions of this clause 13 by you.'
                ),
                // reset subsection numbering
                true && sectionNumbering({ resetSubSection: true })
            ),
        ...
        $('<div class="offerClause "/>').append(
            ...
            $('<ul/>').append(
                ...
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' All rights, titles and interests in the Intellectual Property (the "',
        ...
        $('<div class="offerClause"/>').append(
            ...
            $('<ul/>').append(
                ...
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' Upon the expiry or termination of this Agreement for whatever reason, you shall:'
                ),
                $('<ul/>').append(
                    $('<p/>').html(
        ...
        $('<div class="offerClause"/>').append(
            ...
            $('<ul/>').append(
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' This Agreement supersedes any and all prior correspondence, discussions, agreements, representations, undertakings, and promises of any kind, whether written, oral, express or implied exchanged or made between the parties hereto with respect to the subject matters herein. This Agreement constitutes the entire, full, complete and exclusive agreement and understanding between you and the Company, its officers, employees and its affiliates with respect to the subject matters herein.'
                ),
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' Neither you nor the Company has entered into this Agreement in reliance upon any representation, warranty or undertaking of the other party which is not set out or referred to in this Agreement or referred to in this Agreement as forming part of your employment contract. Nothing in this clause shall however operate to limit or exclude liability for fraud.'
                ),
                // reset subsection numbering
                true && sectionNumbering({ resetSubSection: true })
            ),
        ...
        $('<div class="offerClause"/>').append(
            $('<label/>').append(
                ...
                '. <u>Governing Law </u>'),
            $('<p/>').html('This Agreement shall be governed by and construed in accordance with the laws of Singapore. The parties irrevocably agree to submit to the exclusive jurisdiction of the Singapore courts.'),
            $('<p class="hide"/>').html('<br>')
        ),
        $('<div class="offerClause"/>').append(
            $('<label/>').append(
            ...
            $('<ul/>').append(
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' This Agreement shall not be amended, modified, varied or supplemented unless agreed to in writing by the parties.'
                ),
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                ...
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' You may not assign nor transfer to any third party the benefit and/or burden of this Agreement without the prior written consent of the Company.'
                ),
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                ...
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
                    ' Without prejudice to any other rights or remedies which the Company may have, you acknowledge and agree that damages may not be an adequate remedy for any breach by you of your obligations under this Agreement.'
                ),
                $('<p/>').append(
                    `${sectionNumbers.section}.${sectionNumbering({ incrementSubSection: true }).subSection}`,
        ...
        $('<div class="offerClause "/>').append(
            ...
            $('<p class="margin-bottom"/>').html('For and on behalf of <br>PayPal Pte. Limited')
        )
