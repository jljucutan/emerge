...
const fnView = function() {
    ...
    $("#markup").html("").append(
        ...
        $('<div class="offerClause"/>').append(
            ...
            $('<p/>').append('Subject to you having obtained you having obtained all necessary passport, visa, Work Passes and other required immigration approvals from the relevant government authorities to enable you to reside and to work with the Company in Singapore (if applicable), your employment hereunder shall commence on ',
                $('<mark/>').append(
                    employee.Start_Date
                ),
        ...
        $('<div class="offerClause"/>').append(
            ...
            (employee.Employee_Type == "Rehire" || employee.Employee_Type == "New Hire") &&
            $('<p/>').html('You will be required to serve a probationary period of three months (the "Probationary Period"), during which time your employment with the Company may be terminated by either party giving to the other seven (7) days&#x27; written notice or paying salary in lieu thereof, subject to the relevant provisions of Clause 15 below. The probationary period may be reduced or extended at the discretion of the Company.'),
            (employee.Employee_Type != "Rehire" && employee.Employee_Type != "New Hire") &&
            $('<p/>').html('You are exempt from undergoing a probationary period.'),
            $('<p class="hide"/>').html('<br>')
        ),
        $('<div class="offerClause"/>').append(
            ...
            $('<ul/>').append(
                ...
                $('<ul/>').append(
                    ...
                    $('<p/>').append(
                        '(b) using all reasonable efforts to promote the commercial and ethical interests of the Company and the Group (as defined at clause 12.1 below);'
                    ),
                    $('<p/>').append(
                        '(c) acting in the best interests of the Company and the Group (as defined at clause 12.1 below); and'
                    ),
                    $('<p/>').append(
...
' ',
                ...
                (employee.Relocation == 'Y' && employee.Relo_Lump_Sum_Eligible=='Yes') && 
                $('<p/>').append(
                    '6.8 Should your employment be terminated by PayPal Pte Ltd in accordance with clause 15.2, or as a result of your resignation within one year from your Start Date, you shall, on demand, immediately repay the Company any sums paid to you under the Relocation Package. Your obligation to repay the sums paid to you under the Relocation Package, will be reduced by 1/12th for every full month of active employment from your Start Date.'
                ),
                (employee.Relocation == 'Y' && employee.Relo_Bonus == 'Yes') &&
                $('<p/>').append(
                    '6.9 In addition, PayPal will provide a monthly housing allowance of  ',
                    $('<mark/>').append(
...
' ',
        ...
        (employee.AIP == 'Yes') &&
        $('<div class="offerClause"/>').append(
            $('<label/>').html('<strong>7. <u>Bonus Eligibility </u></strong>'),
            $('<ul class="marked" data-toggle="popover" data-placement="top" data-content="Qualifies for Annual Incentive Plan (AIP)"/>').append(
                $('<p/>').append('7.1 You will be eligible to participate in a PayPal Annual Incentive Plan for a specified fiscal year (“',
                    $('<strong/>').text('AIP'),
                ...
                $('<p/>').html('7.2 To be eligible to receive any AIP Bonus, you must be employed on or before the first business day of the final quarter of the calendar year and you must be in continuous employment, and must not have either given or received notice of termination of your employment for any reason whatsoever on the date the bonus is received, subject to applicable laws. If your employment start date with a PayPal company commences on or after the first U.S. business day in the final quarter of the calendar year, your eligibility to participate in the AIP will begin on January 1st of the following calendar year. Any AIP Bonus is at PayPal’s sole and absolute discretion and subject to the terms and conditions of the AIP. PayPal reserves the right, in its sole discretion, to amend, change or cancel the AIP, and your eligibility to participate in the AIP or any other incentive compensation plan, at any time. Further, the incentive compensation plan that you are eligible to participate in may change over time. You acknowledge and agree that PayPal may substitute the plan referenced in this letter and any contract of employment or any offer documentation, as it determines in its sole discretion from time to time.'),
                $('<p class="hide"/>').html('<br>')
            )
        ),
        $('<div class="offerClause"/>').append(
            $('<label/>').html('<strong>8. <u>Staff Review</u></strong>'),
        ...
        $('<div class="offerClause"/>').append(
            $('<label/>').html('<strong>9. <u>Expenses</u></strong>'),
        ...
        $('<div class="offerClause"/>').append(
            $('<label/>').html('<strong>10. <u>Annual Leave</u></strong>'),
            $('<p/>').append(
                'You shall be entitled to paid annual leave (in addition to gazetted public holidays, and medical leave to which you may be entitled under clause 11 below) (“',
        ...
        $('<div class="offerClause"/>').append(
            $('<label/>').html('<strong>11. <u>Illness, injury and leave</u></strong>'),
            $('<ul/>').append(
                $('<p/>').html('11.1 In the event of any illness or injury incapacitating you from attending to your duties, you shall be entitled to be absent from duties by taking up either the sick leave entitlement or hospitalization leave entitlement in accordance with Singapore law, provided that such leave entitlement can only be taken upon certification by a medical practitioner.'),
                $('<p/>').html('11.2 You will be entitled to all maternity, paternity, childcare and infant care leave entitlements which you are eligible for under Singapore law. More generous entitlements may be provided pursuant to a Company policy in place from time to time.'),
                $('<p/>').html('11.3 Subject to the rules and procedures established by the Company from time to time, all employees shall be entitled to medical benefits in accordance with the Company prevailing benefits policy.')
            ),
            $('<p class="hide"/>').html('<br>')
        ),
        $('<div class="offerClause"/>').append(
            $('<label/>').html('<strong>12. <u>Confidentiality</u></strong>'),
            $('<p/>').html('12.1 In this Agreement, the following terms are defined as follows:'),
            $('<ul/>').append(
                $('<p/>').append(
                    '(a) “',
            ...
            $('<p/>').append('12.6 The restrictions contained in this clause 12 shall not apply:'),
            $('<ul/>').append(
                $('<p/>').append(
            ...
            $('<p/>').append(
                'You acknowledge that the restrictions contained in this clause 12 are reasonable and that irreparable damage will be caused to the Company in the event of any violation of any of the provisions of this clause 12 by you.'
            ),
            $('<p class="hide"/>').html('<br>')
        ),
        $('<div class="offerClause "/>').append(
            $('<label/>').html('<strong>13. <u>Personal Data</u></strong>'),
            $('<p/>').html('13.1 In this clause, the following terms are defined as follows:'),
            $('<ul/>').append(
                $('<p/>').append(
                    '"',
                    $('<strong/>').text('Personal Data'),
                    '" means data, whether true or not, about an individual who can be identified from that data or from that data and other information to which the Company has or is likely to have access; and'
                ),
                $('<p/>').append(
                    '"',
                    $('<strong/>').text('Process'),
            ...
            $('<p/>').html('13.2 You consent, agree and acknowledge that:'),
            $('<ul/>').append(
                $('<p/>').append(
                    '(a) the Company may collect, use and/or Process Personal Data relating to you, including, without limitation, your address, NRIC, passport or similar identification number, references, bank details, work and sickness records, next of kin, remuneration details and other records (which may, where necessary, include data relating to your health and medical condition), for purposes more thoroughly detailed in the PayPal Employee Privacy Notice including those related to personnel administration, management and/or evaluative purposes, corporate group reporting, administration or execution of payment schemes, processing of payment or facilitation of work activities related to your employment;'
                ),
                $('<p/>').append(
                    '(b) the Company may disclose and/or transfer your Personal Data, including to foreign jurisdictions outside Singapore, to:'
                ),
                $('<ul/>').append(
                    $('<p/>').append(
                        '(i) advisers and third party service providers for the rendering of goods or services and/or conduct of legitimate business activity (including, without limitation, personnel administration, management and/or evaluative purposes), for the purposes set out in sub-paragraph (a) and more fully detailed in the PayPal Employee Privacy Notice;'
                    ),
                    $('<p/>').append(
                        '(ii any competent legal and/or regulatory authority and law enforcement agencies as may be required under applicable law; and'
                    ),
                    $('<p/>').append(
                        '(iii)  the Company\’s successor-in-title, prospective seller or buyer of any part or the whole of our business, in connection with a merger, acquisition or sale of any part or the whole of the Company\'s business;'
                    )
                ),
                $('<p/>').append(
                    '(c) your right of access to and correction of your Personal Data that is in the possession or control of the Company shall be as prescribed by applicable law and details on how to request access to or correction of your Personal Data can be found in the PayPal Employee Privacy Notice; and'
                ),
                $('<p/>').append(
                    '(d) the Company may retain your Personal Data as may be necessary or desirable to comply with applicable law, and for such period of time as may be reasonably required by the Company in accordance with relevant circumstances, including where required, with third parties appointed by the Company under formal agreements to act as custodians of your Personal Data, or for Processing of the same by such third parties, in each case subject to confidential agreements under which the Company will exercise control and require standards as to safekeeping. The foregoing statement where contained in this Agreement as accepted and acknowledged by you shall stand as your formal consent to the above arrangements and terms as they relate to your Personal Data.'
                )
            ),
            $('<p/>').html('13.3 The Company reserves the right to update its data protection arrangements including, without limitation, issuing of further notices, guidelines or policies as may be required by it or by law or as may be relevant from time to time. You agree to abide by such updates and, generally, where necessary, agree to respond promptly to any requests for further consents (whether by ad hoc request or by way of such updates) as to the use of your Personal Data as required by the Company from time to time whether the same are issued via internal email, circular or other means, each of which you acknowledge and accept is a valid method of seeking and obtaining your further consent.'),
            $('<p/>').html('13.4 By signing this Agreement, you expressly consent to the above terms as regards your Personal Data, during and after your employment.'),
            $('<p class="hide"/>').html('<br>')
        ),
        $('<div class="offerClause "/>').append(
            $('<label/>').html('<strong>14. <u>Intellectual Property</u></strong>'),
            $('<ul/>').append(
                $('<p/>').append(
                    '14.1 Without limiting the foregoing, if at any time during your employment with the Company you create or discover or participate in the creation or discovery of any intellectual property, any invention or improvement upon or addition to an invention, including without limitation copyrights, patents, trade marks, design rights and all similar proprietary rights as may exist anywhere in the world (whether registered or unregistered) (the "',
                    $('<strong/>').text('Intellectual Property'),
                    '"), you shall inform the Company and comply with your obligations under this clause 14 as well as your obligations under the Employee Proprietary Information and Inventions Agreement (the “',
                    $('<strong/>').text('Inventions Agreement'),
                    '”).'
                ),
                $('<p/>').append(
                    '14.2 All rights, titles and interests in the Intellectual Property (the "',
                ...
                $('<p/>').append(
                    '14.3 You shall, at the cost of the Company, provide all such information, data, drawings and assistance as may be requested by the Company to enable the Company to use and fully exploit all the Intellectual Property Rights and you will execute all documents and do all things which may be necessary or desirable for obtaining protection for the Intellectual Property Rights in such parts of the world as may be specified by the Company and for vesting the Intellectual Property Rights in the Company or as the Company may direct from time to time. In particular, but without limitation, in any instance where the provisions of this Clause 14.3 are, pursuant to any applicable law, not fully effective in ensuring that the Intellectual Property Rights are automatically owned by the Company, you shall (if requested by the Company) sign all papers and execute all documents, including without limitation patent applications, trade mark applications, service mark applications, declarations, oaths, formal assignments, assignment of priority rights, and powers of attorney, and do all things, which the Company may deem necessary or desirable in order to protect its rights and interests in respect of the Intellectual Property Rights'
                ),
                $('<p/>').append(
                    '14.4 You acknowledge that the Company exclusively owns all Intellectual Property Rights in any material created, generated or contributed to by you in connection with your employment. You warrant that the Intellectual Property in any material created, generated or contributed to by you in connection with your employment does not and will not infringe the Intellectual Property or other rights of a third party and you will indemnify the Company for any loss or damage incurred in the event that you contravene this clause.'
                ),
                $('<p/>').append(
                    '14.5 You agree to assign to the Company all pre-existing Intellectual Property and Intellectual Property Rights in any material created, generated, used or contributed to or by you in connection with your employment. '
                ),
                $('<p/>').append(
                    '14.6 You irrevocably appoint the Company to be your attorney in your name and on your behalf to sign or execute any such instrument or thing and generally to use your name for the purpose of giving to the Company (or its nominee) the full benefit of the provisions of this clause 14 relating to the Intellectual Property Rights only.'
                ),
                $('<p/>').append(
                    '14.7 Insofar as permitted by applicable law, you waive any and all of your rights in relation to the Intellectual Property Rights and you shall not assert any right or to institute, support, maintain or permit any action or claim based on or in connection with the infringement or the alleged infringement of your rights.'
                ),
                $('<p/>').append(
                    '14.8 You acknowledge that your obligations under this clause 14 are in addition to those contained in the Inventions Agreement, and that in the event of any conflicting obligations, the obligations contained in the Inventions Agreement shall prevail.'
                )
            ),
            $('<p class="hide"/>').html('<br>')
        ),
        $('<div class="offerClause"/>').append(
            $('<label/>').html('<strong>15. <u>Termination</u></strong>'),

            $('<p/>').html('15.1 Upon signing this offer letter, and after the probationary period referred to in Clause 2 above and subject to Clause 15.2 below, this Agreement may be terminated by you or by the Company upon giving two (2) months&#x27; written notice or by paying two (2) months&#x27; salary in lieu of notice. The Company reserves the right to require you not to attend work and/or not to undertake all or any of your duties of employment during any period of notice (whether given by you or the Company). However, the Company shall continue to pay your salary and contractual benefits whilst you remain employed by the Company.'),

            $('<p/>').html('15.2 Notwithstanding the other provisions in this Agreement The Company shall be entitled to terminate your employment immediately without written notice (and without prejudice to the rights and remedies of the Company including for any breach of this Agreement and to your continuing obligations under this Agreement) in any of the following cases:'),
            $('<ul/>').append(
                $('<p/>').html(
            ...
            $('<p/>').html('15.3 Upon the expiry or termination of this Agreement for whatever reason, you shall:'),
            $('<ul/>').append(
                $('<p/>').html(
        ...
        $('<div class="offerClause "/>').append(
            ...
            $('<ul/>').append(
                ...
                $('<ul/>').append(
                    $('<p/>').append(
                        '(a) each of the undertakings contained in clauses 16.1 and 16.2 above constitutes an entirely separate and independent restriction on you;'
                    ),
                    $('<p/>').append(
                        '(b) the undertakings contained in clauses 16.1 and 16.2 above are reasonable to protect the legitimate interests of the Company given that you will have access to Confidential Information and have influence over the employees, suppliers and/or customers of the Company; and'
                    ),
                    $('<p/>').append(
                        '(c) the duration, extent and application of each of the undertakings contained in clauses 16.1 and 16.2 above are no greater than is necessary for the protection of the proprietary interests of the Company.'
                    )
                ),
                $('<p/>').append(
                    '16.4 Notwithstanding the above, you shall be entitled to enter into employment with any other related corporation of the Company.'
                ),
                $('<p/>').append(
                    '16.5 Each undertaking and agreement contained in this clause shall be read and construed independently of the other undertakings and agreements herein contained so that if one or more should be held to be invalid as an unreasonable restraint of trade or for any other reason whatsoever then the remaining undertakings and agreements shall be valid to the extent that they are held not to be so invalid.'
                ),
                $('<p/>').append(
                    '16.6 While the undertakings and agreements in this clause 16 are considered by the Company and you to be reasonable in all circumstances, if one or more should be held to be invalid as an unreasonable restraint of trade or for any other reason whatsoever but would have been held valid if part of the wording thereof had been deleted or the period thereof reduced or the range of activities or area dealt with reduced in scope, the said undertakings and agreements shall apply with such modifications as may be necessary to make them valid and effective.'
                ),
                $('<p/>').append(
                    '16.7 You acknowledge that a breach of this clause 16 will immediately and irreparably harm the Company and as such, you consent to a grant of temporary and permanent injunctive relief against such breach and any further breach. The foregoing is without prejudice to the Company’s right to claim for damages caused to it as a result of the said breach and any other remedy available at law or in equity.'
                )
            ),
            $('<p class="hide"/>').html('<br>')
        ),
        $('<div class="offerClause"/>').append(
            $('<label/>').html('<strong>17. <u>Repatriation obligation</u></strong>'),
        ...
        $('<div class="offerClause"/>').append(
            $('<label/>').html('<strong>18. <u>Entire Agreement</u></strong>'),
            $('<ul/>').append(
                $('<p/>').html('18.1 This Agreement supersedes any and all prior correspondence, discussions, agreements, representations, undertakings, and promises of any kind, whether written, oral, express or implied exchanged or made between the parties hereto with respect to the subject matters herein. This Agreement constitutes the entire, full, complete and exclusive agreement and understanding between you and the Company, its officers, employees and its affiliates with respect to the subject matters herein.'
                ),
                $('<p/>').html('18.2 Neither you nor the Company has entered into this Agreement in reliance upon any representation, warranty or undertaking of the other party which is not set out or referred to in this Agreement or referred to in this Agreement as forming part of your employment contract. Nothing in this clause shall however operate to limit or exclude liability for fraud.'
                )
            ),
            $('<p class="hide"/>').html('<br>')
        ),
        ...
        $('<div class="offerClause"/>').append(
            $('<label/>').html('<strong>19. <u>No Breach</u></strong>'),
        ...
        $('<div class="offerClause"/>').append(
            $('<label/>').html('<strong>20. <u>Governing Law </u></strong>'),
        ...
        $('<div class="offerClause"/>').append(
            $('<label/>').html('<strong>21. <u>Miscellaneous </u></strong>'),
            $('<ul/>').append(
                $('<p/>').html('21.1 This Agreement shall not be amended, modified, varied or supplemented unless agreed to in writing by the parties.'
                ),
                $('<p/>').html('21.2 The illegality, invalidity or unenforceability of any provision of this Agreement under the law of any jurisdiction shall not affect its legality, validity or enforceability under the law of any other jurisdiction nor the legality, validity or enforceability of any other provision.'
                ),
                $('<p/>').html('21.3 You may not assign nor transfer to any third party the benefit and/or burden of this Agreement without the prior written consent of the Company.'
                ),
                $('<p/>').html('21.4 No failure on the part of any party to exercise, and no delay on its part in exercising, any right or remedy under this Agreement will operate as a waiver thereof, and any single or partial exercise of any right or remedy shall not preclude any other or further exercise thereof or the exercise of any other right or remedy. The rights provided in this Agreement are cumulative and not exclusive of any rights or remedies provided by law.'
                ),
                $('<p/>').html('21.5 Without prejudice to any other rights or remedies which the Company may have, you acknowledge and agree that damages may not be an adequate remedy for any breach by you of your obligations under this Agreement.'
                ),
                $('<p/>').html('21.6    A person who is not party to this Agreement has no rights under the Contracts (Rights of Third Parties) Act (Chapter 53B of Singapore) to enforce any term of this Agreement, but this does not affect any right or remedy of a third party which exists or is available apart from the said Act.'
                )
