// Japan Internal Corporate Offer
function fnView() {
    ...
    $("#markup").html("").append(
        ...
        $('<div class="offerClause"/>').append(
            ...
            $('<div/>').append(
                $('<p/>').html(
                    'Apple Japan, Inc. (’Apple’) is delighted to offer you the position of ' + employee.Job_Title + ' and the job level of ' + employee.Compensation_Grade + '. In your new position you will report to ' + employee.Hiring_Manager + ' and your place of work will be Roppongi Hills, 6-10-1, Roppongi, Minato-ku, Tokyo. These conditions may be subject to change at the Apple’s discretion.'
                ),
                $('<p/>').html(
                    'Apple Japan合同会社(以下「Apple」といいます)は、あなたを' + employee.Compensation_Grade + 'の、' + employee.Job_Title + 'のポジションで採用させていただきたく、お知らせ致します。この新たなポジションでは、' + employee.Hiring_Manager + 'があなたの上司となり、勤務地は東京都港区六本木6-10-1 六本木ヒルズとなります。ここに記載する条件は、Appleの裁量で変更する場合があります。'
                )
            ),
            // Work Location == YTC
            ...
            $('<div/>').append(
                $('<p/>').html(
                    'Apple Japan, Inc. (’Apple’) is delighted to offer you the position of ' + employee.Job_Title + ' and the job level of ' + employee.Compensation_Grade + '. In your new position you will report to ' + employee.Hiring_Manager + ' and your place of work will be Apple Japan YTC, 4-3-1, Tsunashimahigashi, Kohoku-ku, Yokohama-shi, Kanagawa. These conditions may be subject to change at the Apple’s discretion.'
                ),
                $('<p/>').html(
                    'Apple Japan合同会社(以下「Apple」といいます)は、あなたを' + employee.Compensation_Grade + 'の、' + employee.Job_Title + 'のポジションで採用させていただきたく、お知らせ致します。この新たなポジションでは、' + employee.Hiring_Manager + 'があなたの上司となり、勤務地は神奈川県横浜市港北区綱島東4-3-1 Apple Japan YTCとなります。ここに記載する条件は、Appleの裁量で変更する場合があります。'
                )
            ),
            // Work Location == Home Office and Offer Type == DC AHA, AHA 
            (employee.Work_Location == 'Home Office') &&  (employee.Offer_Type == 'DC AHA' || employee.Offer_Type == 'AHA') &&
            $('<div/>').append(
            $('<p/>').html(
                'Apple Japan, Inc. (’Apple’) is delighted to offer you the position of ' + employee.Job_Title + ' and the job level of ' + employee.Compensation_Grade + '. In your new position you will report to ' + employee.Hiring_Manager + ' and your place of work will be at your residence and other training locations as designated by Apple from time to time according to Apple-At-Home Advisor Program Agreement (’AHA Agreement’) signed by you. The conditions set out in this offer may be subject to change at the Apple’s discretion.'
            ),
            $('<p/>').html(
                'Apple Japan合同会社(以下「Apple」といいます)は、あなたを' + employee.Compensation_Grade + 'の、' + employee.Job_Title + 'のポジションで採用させていただきたく、お知らせ致します。この新たなポジションでは、' + employee.Hiring_Manager + 'があなたの上司となり、就労場所はあなたの自宅又はあなたが署名したApple-At-Home Advisor Program 契約(以下、「AHA契約」といいます)に基づきAppleが随時指定する研修場所となります。ここに記載する条件は、Appleの裁量で変更する場合があります。'
            )
            ),
            ...
            $('<p/>').html(
                'Apple Japan合同会社(以下「Apple」といいます)は、あなたを' + employee.Compensation_Grade + 'の、' + employee.Job_Title + 'のポジションで採用させていただきたく、お知らせ致します。この新たなポジションでは、' + employee.Hiring_Manager + 'があなたの上司となり、就労場所はあなたの自宅又はあなたが署名したRCC At-Home Specialist Program 契約(以下、「AHS契約」といいます)に基づきAppleが随時指定する研修場所となります。ここに記載する条件は、Appleの裁量で変更する場合があります。'
            )
            ),
            ...
            $('<div/>').append(
                $('<p/>').html(
                    'Apple Japan, Inc. (’Apple’) is delighted to offer you the position of ' + employee.Job_Title + ' and the job level of ' + employee.Compensation_Grade + '. In your new position you will report to ' + employee.Hiring_Manager + ' and your place of work will be Apple distributor consumer electronic retail shop. These conditions may be subject to change at the Apple’s discretion.'
                ),
                $('<p/>').html(
                    'Apple Japan合同会社(以下「Apple」といいます)は、あなたを' + employee.Compensation_Grade + 'の、' + employee.Job_Title + 'のポジションで採用させていただきたく、お知らせ致します。この新たなポジションでは、' + employee.Hiring_Manager + 'があなたの上司となり、勤務地は入社にあたり指定するAppleショップならびにその他のApple製品取扱店となります。ここに記載する条件は、Appleの裁量で変更する場合があります。'
                )
            ),
            ...
            $('<div/>').append(
                ...
                $('<p/>').html(
                    'iTunes 株式会社(以下、「Apple」といいます)は、' + employee.Compensation_Grade + 'の、' + employee.Job_Title + 'のポジションで採用させていただきたく、お知らせ致します。この新たなポジションでは、' + employee.Hiring_Manager + 'があなたの上司となり、勤務地は東京都港区六本木6-10-1 六本木ヒルズとなります。ここに記載する条件は、Appleの裁量で変更することがあります。'
                )

            ),
            
            // Work Location == Retail Stores
            (employee.Work_Location_Retail == 'Fukuoka Tenjin' || employee.Work_Location_Retail == 'Ginza' || employee.Work_Location_Retail == 'Kanagawa' || employee.Work_Location_Retail == 'Kyoto' || employee.Work_Location_Retail == 'Nagoya Sakae' || employee.Work_Location_Retail == 'Omotesando' || employee.Work_Location_Retail == 'Sendai Ichibancho' || employee.Work_Location_Retail == 'Shibuya' || employee.Work_Location_Retail == 'Shinjuku' || employee.Work_Location_Retail == 'Shinsaibashi' || employee.Work_Location_Retail == 'Tokyo' || employee.Work_Location_Retail == 'Marunouchi') &&
            $('<div/>').append(
                $('<p/>').html(
                    'Apple Japan, Inc. (’Apple’) is delighted to offer you the position of ' + employee.Job_Title + ' with the job level of ' + employee.Compensation_Grade + '. In your new position you will report to ' + employee.Hiring_Manager + ', at Apple Store, ' + employee.Work_Location_Retail + '. These conditions may be subject to change at the Apple’s discretion.'
                ),
                $('<p/>').html(
                    'Apple Japan 合同会社（以下「Apple」といいます）は、 あなたをアップルストア' + employee.Work_Location + '店にて' + employee.Compensation_Grade + 'の、' + employee.Job_Title + 'のポジションで採用させていただきたく、お知らせ致します。この新たなポジションでは、' + employee.Hiring_Manager + 'があなたの上司となります。ここに記載する条件は、Apple の裁量で変更する場合があります。'
                )
            ),
            // New Offer Type == Standard
            ...
            $('<div/>').append(
                $('<p/>').html(
                    'Commencement'
                                ...
                                (employee.Student_Conversion != 'Yes') &&
                $('<p/>').html(
                    'Your effective start date with Apple will be ' + employee.English_Start_Date + '.'
                ),
                                (employee.Student_Conversion == 'Yes') &&
                $('<p/>').html(
                    'Your effective start date with Apple will be ' + employee.English_Start_Date + ', subject to you graduating from your college and obtaining graduation certificate.'
                ),
                $('<p/>').html(
                    '雇用の開始'
                ),
                                (employee.Student_Conversion != 'Yes') &&
                $('<p/>').html(
                    'Appleでの雇用開始日は、' + employee.Japanese_Start_Date + 'です。'
                ),
                                (employee.Student_Conversion == 'Yes') &&
                $('<p/>').html(
                    'Appleでの雇用開始日は、' + employee.Japanese_Start_Date + 'で、あなたが大学を卒業し、卒業証明書を入手することを条件とします。'
                )
            ),
            // New Offer Type == Fixed Term
            ...
            // New Employee Type == Full Time AND New Offer Type == Standard or Fixed Term General
            (employee.New_PT_or_FT == 'FT' && (employee.Offer_Type == 'Fixed Term General' || employee.Offer_Type == 'Standard General')) &&
            $('<div/>').append(
                $('<p/>').html(
            ...
            // New Employee Type == Full Time AND New Offer Type == ASC
            (employee.New_PT_or_FT == 'FT' && (employee.Offer_Type == 'ASC' || employee.Offer_Type == 'DC ASC')) &&
            $('<div/>').append(
                $('<p/>').html(
                    'Hours of Work, Holidays'
                ),
            ...
            // New Employee Type == Full Time AND New Offer Type == AHA, DC AHA
            (employee.New_PT_or_FT == 'FT' && (employee.Offer_Type == 'AHA' || employee.Offer_Type == 'DC AHA')) &&
            $('<div/>').append(
                $('<p/>').html(
                    'Hours of Work, Holidays'
                ),
...
// Employee Type == Full Time AND Offer Type == Siri
            (employee.New_PT_or_FT == 'FT' && (employee.Offer_Type == 'Siri')) &&
            $('<div/>').append(
                $('<p/>').html(
                    'Hours of Work, Holidays'
                ),
            ...
            // New Employee Type == Full Time AND New Offer Type == RCC
            (employee.New_PT_or_FT == 'FT' && (employee.Offer_Type == 'RCC')) &&
            $('<div/>').append(
                $('<p/>').html(
                    'Hours of Work, Holidays'
                ),
            ...
            // New Employee Type == Part Time AND New Offer Type != ASC, DC ASC, AHA
            (employee.New_PT_or_FT == 'PT' && (employee.Offer_Type != 'ASC' && employee.Offer_Type != 'AHA' && employee.Offer_Type != 'DC ASC')) &&
            $('<div/>').append(
                $('<p/>').html(
                    'Hours of Work'
                ),
            ...
            // New Employee Type == Part Time AND New Offer Type == ASC or DC ASC
            (employee.New_PT_or_FT == 'PT' && (employee.Offer_Type == 'ASC' || employee.Offer_Type == 'DC ASC')) &&
            $('<div/>').append(
                $('<p/>').html(
                    'Hours of Work'
                ),
            ...
            // New Offer Type == Retail Leadership
            ...
            // New Offer Type == Standard AND New Offer Type != ASC
            ...
            // New Employee Type == Full Time AND New Offer Type == Standard
            (employee.New_PT_or_FT == 'FT' && (employee.Offer_Type == 'AHA' || employee.Offer_Type == 'ASC' || employee.Offer_Type == 'Standard General' || employee.Offer_Type == 'Retail Leadership' || employee.Offer_Type == 'RCC' || employee.Offer_Type == 'Siri')) &&
            $('<div/>').append(
                $('<p/>').html(
                    'Salary'
                ),
                $('<p/>').html(
                    'You will receive an annual base salary of ' + employee.Annual_Salary + ' yen (less deductions required by local laws) payable on a monthly basis in 12 equal installments in accordance with Apple’s standard payroll procedures. Apple reserves the right to modify salaries and benefits from time to time as it deems necessary.'
                ),
(employee.JP_OT_Compensation == 'OT-Exempt') &&
                ...
                $('<p/>').html(
                    '給与は、年収で' + employee.Annual_Salary + '円(この額から、勤務地の所得税その他法令に定められたものを控除します)とし、Appleの給与支払い手順に従い、毎月一度、年収額を12分割した金額をお支払いします。Appleは、必要に応じて随時給与及び福利厚生を変更する権利を留保します。'
                ),
                (employee.JP_OT_Compensation == 'OT-Exempt') &&
                $('<p/>').html(
            ...
            // New Employee Type == Full Time AND New Offer Type == Fixed Term
            (employee.New_PT_or_FT == 'FT' && (employee.Offer_Type == 'DC AHA' || employee.Offer_Type == 'DC ASC' || employee.Offer_Type == 'Fixed Term General')) &&
            $('<div/>').append(
                $('<p/>').html(
                    'Salary'
                ),
                $('<p/>').html(
                    'You will receive a monthly base salary of ' + employee.Monthly_Salary + ' yen (less deductions required by local laws) payable on a monthly basis in accordance with Apple’s standard payroll procedures. Apple reserves the right to modify salaries and benefits from time to time as it deems necessary.'
                ),
(employee.JP_OT_Compensation == 'OT-Exempt') &&
                $('<p/>').html(
                    'Your base salary is inclusive of compensation for night-time work, as detailed in the Rules of Employment.'
                ...
                $('<p/>').html(
                    '給与は、月額' + employee.Monthly_Salary + '円の基本給(この額から、勤務地の所得税その他法令に定められたものを控除します)とし、Appleの給与支払い手順にしたがい、年、毎月一度の支払いとなります。Appleは、必要に応じて随時給与及び福利厚生を変更する権利を留保します。'
                ),
                (employee.JP_OT_Compensation == 'OT-Exempt') &&
                $('<p/>').html(
                    'あなたの基本給は、就業規則の定めのとおり、時間外労働に対する割増手当を含みます'
            ...
            // New Employee Type == Part Time
            (employee.New_PT_or_FT == 'PT') &&
            $('<div/>').append(
                $('<p/>').html(
                    'Salary'
                ),
                $('<p/>').html(
                    'You will receive an hourly base salary of ' + employee.Hourly_Salary + ' yen (less deductions required by local laws) payable once a month in accordance with Apple’s standard payroll procedures. Apple reserves the right to modify salaries and benefits from time to time as it deems necessary.'
                ),
                               (employee.JP_OT_Compensation == 'OT-Exempt') &&
                $('<p/>').html(
                    'Your base salary is inclusive of compensation for night-time work, as detailed in the Rules of Employment.'
                ...
                $('<p/>').html(
                    '給与は、時給' + employee.Hourly_Salary + '円(この額から、勤務地の所得税その他法令に定められたものを控除します)とし、Appleの給与支払い手順にしたがい、毎月一度支払います。Appleは、必要に応じて適時に給与及び福利厚生を変更する権利を留保します。'
                ),
                                (employee.JP_OT_Compensation == 'OT-Exempt') &&
                $('<p/>').html(
                    'あなたの基本給は、就業規則の定めのとおり、時間外労働に対する割増手当を含みます'
            ...
            (employee.Compensation_Plan=='60_40_Base_Target_Plan') &&
            $('<div/>').html(
                $('<p/>').html(
                    'You will participate in the Apple Asia Pacific Sales Compensation Plan which pays a target commission of 40% on On-Target Earning (OTE). Your OTE will be ' + employee.OTE_Amount + ' yen per annum. This plan, including the split between the base pay and variable commission of 60:40 ratio may be subject to change. These changes, if any, will be made at Apple’s absolute discretion to which you consent by accepting this offer.'
                ),
                $('<p/>').html(
                    'あなたは、On Target Earning(OTE)を達成した場合に、 40%のコミッションが支払われるApple Asia Pacific Sales Compensation Planに参加します。あなたのOTEは、年間' + employee.OTE_Amount + '円とします。基本給と変動コミッションの割合60:40を含め、このプランの内容は、変更し得ます。Appleは、その完全な裁量で随時かかる変更を可能とし、あなたの本オファーの受諾は、かかる変更への承諾を含むものとします。'
                )
            ),
            ...
            $('<div/>').html(
                $('<p/>').html(
                    'You will participate in the Apple Asia Pacific Sales Compensation Plan which pays a target commission of 30% on On-Target Earning (OTE). Your OTE will be ' + employee.OTE_Amount + ' yen per annum. This plan, including the split between the base pay and variable commission of 70:30 ratio may be subject to change. These changes, if any, will be made at Apple’s absolute discretion to which you consent by accepting this offer.'
                ),
                $('<p/>').html(
                    'コミッション'
                ),
                $('<p/>').html(
                    'あなたは、On Target Earning(OTE)を達成した場合に、 30%のコミッションが支払われるApple Asia Pacific Sales Compensation Planに参加します。あなたのOTEは、年間' + employee.OTE_Amount + '円とします。基本給と変動コミッションの割合70:30を含め、このプランの内容は、変更し得ます。Appleは、その完全な裁量で随時かかる変更を可能とし、あなたの本オファーの受諾は、かかる変更への承諾を含むものとします。'
                )
            ),

            (employee.Compensation_Plan=='80_20_Base_Target_Plan') &&
            $('<div/>').html(
                $('<p/>').html(
                    'You will participate in the Apple Asia Pacific Sales Compensation Plan which pays a target commission of 20% on On-Target Earning (OTE). Your OTE will be ' + employee.OTE_Amount + ' yen per annum. This plan, including the split between the base pay and variable commission of 80:20 ratio may be subject to change. These changes, if any, will be made at Apple’s absolute discretion to which you consent by accepting this offer.'
                ),
                $('<p/>').html(
                    'コミッション'
                ),
                $('<p/>').html(
                    'あなたは、On Target Earning(OTE)を達成した場合に、 20%のコミッションが支払われるApple Asia Pacific Sales Compensation Planに参加します。あなたのOTEは、年間' + employee.OTE_Amount + '円とします。基本給と変動コミッションの割合80:20を含め、このプランの内容は、変更し得ます。Appleは、その完全な裁量で随時かかる変更を可能とし、あなたの本オファーの受諾は、かかる変更への承諾を含むものとします。'
                )
            ),
            ...
            // Discretionary Bonus 
           ((employee.Compensation_Grade == 'MGR 3' || employee.Compensation_Grade == 'MGR 2' || employee.Compensation_Grade == 'MGR 1' || employee.Compensation_Grade == 'ICT 6' || employee.Compensation_Grade == 'IC 6' || employee.Compensation_Grade == 'ICT 5' || employee.Compensation_Grade == 'IC 5' || employee.Compensation_Grade == 'ICT 4' || employee.Compensation_Grade == 'IC 4' || employee.Compensation_Grade == 'ICT 3' || employee.Compensation_Grade == 'IC 3' || employee.Compensation_Grade == 'SUP' || employee.Compensation_Grade == 'SUP 2') && (employee.Offer_Type != 'DC AHA' && employee.Offer_Type != 'DC ASC' && employee.Offer_Type != 'Fixed Term General')) && (employee.Target == '') &&
            $('<div/>').append(
            ...
            // New Employee Type == Full Time
            (employee.New_PT_or_FT == 'FT') &&
            $('<div/>').append(
                $('<p/>').html(
            ...
            // New Employee Type == Part Time || ndugang
            (employee.New_PT_or_FT == 'PT') &&
            $('<div/>').append(
                $('<p/>').html(
                    'Benefits and Social insurance'
            ...
            $('<div/>').append(
                ...
                (employee.Internal_Movement == 'Local Business Group Transfer' || employee.Internal_Movement == 'International Transfer') &&
                $('<p/>').html(
                    '- You must sign the Confidentiality and Intellectual Property Agreement and return the signed agreement with this offer letter. Any exceptions or approvals required under the terms of the Confidentiality and Intellectual Property Agreement must be approved by your division’s senior vice president and Apple’s Legal Department prior to your beginning work.'
                ),
                (employee.Internal_Movement == 'Renewal' || employee.Internal_Movement == 'Conversion') &&
                $('<p/>').html(
                ...
                (employee.Internal_Movement == 'Local Business Group Transfer' || employee.Internal_Movement == 'International Transfer') &&
                $('<p/>').html(
                    '-署名済みの本採用通知と共に、署名済みの秘密保持および知的財産に関する契約も提出しなければなりません。上記秘密保持および知的財産に関する契約の条件に関し、例外がある場合または承認を要する場合には、あなたが勤務を開始する前に、必ずあなたの部門のシニア・バイス・プレジデントおよびApple法務部の承認を取得しなければなりません。'
                ),
                (employee.Internal_Movement == 'Renewal' || employee.Internal_Movement == 'Conversion') &&
                $('<p/>').html(
            ...
            // Work Location != iTunes AND New Offer Type == Standard General
            ...
            //2019-08-20 | SERVICES-38718 | CDY | V6
            // Work Location != iTunes AND New Offer Type == Standard General 
             (employee.Work_Location != 'iTunes' && (employee.Offer_Type == 'Standard General' || employee.Offer_Type == 'Retail Leadership' || employee.Offer_Type == 'RCC'  || employee.Offer_Type == 'Siri')) &&
            $('<div/>').append(
                $('<p/>').html(
                    'Termination'
                ),
            ...
            //2019-08-20 | SERVICES-38718 | CDY | V6 | Added Probation == Yes
            // Work Location != iTunes AND New Offer Type == AHA
         ...
         //2019-08-20 | SERVICES-38718 | CDY | V6 | 
         // Work Location != iTunes AND New Offer Type == AHA 
            (employee.Work_Location != 'iTunes' && employee.Offer_Type == 'AHA') &&
            $('<div/>').append(
                $('<p/>').html(
                    'Termination'
                ),
         ...
         //2019-08-20 | SERVICES-38718 | CDY | V6 | Added Probation == Yes
            // Work Location != iTunes AND New Offer Type == ASC
            ...
            $('<div/>').append(
             ...
             //2019-08-20 | SERVICES-38718 | CDY | V6   
        // Work Location != iTunes AND New Offer Type == ASC 
            (employee.Work_Location != 'iTunes' && employee.Offer_Type == 'ASC') &&
            $('<div/>').append(
                $('<p/>').html(
                    'Termination'
                ),
            ...
            // Work Location != iTunes AND New Offer Type == DC ASC
            ...
            // Work Location != iTunes AND New Offer Type == Fixed Term General
            ...
            // Work Location != iTunes AND New Offer Type == DC AHA
            ...
            // Work Location != iTunes AND New Offer Type != AHA, DC ASC, DC AHA
        ...
        // Work Location == iTunes 
            ...
            $('<div/>').append(
                ...
                $('<p/>').html(
                    employee.First_Name + ', please accept this offer by signing below. Be sure to retain copies for your personal records. If you have any questions regarding this offer or any of its enclosures, please contact me at candidatecare_apac@apple.com.'
                 ),
                $('<p/>').html(
