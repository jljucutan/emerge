...
function fnView() {
    $("#markup").html("").append(
        ...
        $('<div class="row vspace"/>').append(
          ...
          (employee.UK_Contract_Type != 'BGT') &&
          $('<p/>').append('Your employment will begin' + employee.UK_Start_Date),
          ...
          (employee.UK_Contract_Type == 'BGT') &&
          $('<p/>').append('Your period of continuous employment began on ' + employee.UK_Original_Start_Date +  '.'
          )
        ),
        $('<div class="row vspace"/>').append(
          $('<div class="col-lg-12"/>').append(
            '<h5><strong>Probation Period</strong></h5>',
            (employee.UK_Contract_Type == 'MANAGER' || employee.UK_Contract_Type == 'SALARIED' || employee.UK_Contract_Type == 'STORE_LEADER' || employee.UK_Contract_Type == 'MARKET LEADER' || employee.UK_Contract_Type == 'RETAIL CORPORATE' || employee.UK_Contract_Type == 'DIRECTOR') &&
            ...
            (employee.UK_Contract_Type == 'BGT') &&
            $('<p/>').append('Given your previous service in a similar role within the Apple Group, there is no probationary period applicable to your employment.')
          ),
        ),
        $('<div class="row vspace"/>').append(
          $('<div class="col-lg-12"/>').append(
            ...
            (['DIRECTOR', 'GRS'].indexOf(employee.UK_Contract_Type) > -1) &&
        ...
        $('<div class="row vspace"/>').append(
          $('<div class="col-lg-12"/>').append(
            ...
            (['MANAGER', 'SALARIED', 'STORE_LEADER', 'MARKET LEADER', 'ASLP'].indexOf(employee.UK_Contract_Type) > -1) &&
        ...
        $('<div class="row vspace"/>').append(
          $('<div class="col-lg-12"/>').append(
            ...
            (employee.Discretionary_Bonus == 'GRS') &&
        ...
        $('<div class="row vspace"/>').append(
          $('<div class="col-lg-12"/>').append(
            ...
            (['Manager', 'Store_Leader', 'ASLP'].indexOf(employee.UK_Contract_Type) < 0) &&
        ...
        $('<div class="row vspace"/>').append(
          $('<div class="col-lg-12"/>').append(
            ...
            (['STORE_LEADER', 'MARKET_LEADER', 'DIRECTOR', 'GRS'].indexOf(employee.UK_Contract_Type) > -1) &&
