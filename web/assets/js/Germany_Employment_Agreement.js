...
// 2121-02-15 | jjucutan | version 7 created
// 2121-03-01 | jjucutan | version 8 created
function fnView() {
    "use strict";

    let footer = '';
    if (employee.EntityName === "PayPal PLC, German Branch") {
    ...
    if (employee.EntityName === "PayPal Deutschland GmbH") {
    ...
    $("#markup").html("").append(
        ...
        $('<div class="offerClause"/>').append(
            incrementFooterSpaces(33),
            $('<p class="center"/>').append(
                $('<strong/>').append(
                    (/^T/.test(employee.Employee_Group)) && $('<span class="dynamic"/>').append(
                        'BEFRISTETER'
                    ),
                    ' ARBEITSVERTRAG'
                )
            ...
            (employee.EntityName == 'PayPal PLC, German Branch') && $('<p class="center"/>').append(
                'PayPal PLC, Ballycoolin Business Park, Ballycoolin Road, Blanchardstown, Dublin 15, Ireland'
            ),
            (employee.EntityName == 'PayPal Deutschland GmbH') && $('<p class="center"/>').append(
            ...
            $('<p class="center"/>').append(
                ...
                (employee.Address2.length < 0) && decrementFooterSpaces(1),
            ...
            $('<p/>').html(
                '<em>Zur sprachlichen Vereinfachung wird im Rahmen dieses Arbeitsvertrags die Bezeichnung “Mitarbeiter” sowohl für weibliche als auch für männliche Mitarbeiter verwendet.</em>'
            ),
            $('<p/>').append(
                $('<ol/>').append(
                    ...
                    $('<li/>').append(
                        ...
                        $('<ul/>').append(
                            $('<div/>').append(
                                $('<div/>').append(
                                    '1.1.   Der Mitarbeiter wird ab dem ',
                                    $('<span class="dynamic"/>').append(employee.German_Event_Start_Date),
                                    ',  unter der Voraussetzung eines positiv abgeschlossenen Background Check, als ',
                                    $('<span class="dynamic"/>').append(employee.German_Business_Title),
                                    ' bei der Gesellschaft eingestellt. Er berichtet an den von der Gesellschaft jeweils benannten Vorgesetzten.'
                                ),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                                (employee.Entity_Transfer == 'Yes') &&
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Transferring from another PP entity"/>').prop('id', makeid()).append(
                                    '1.2. Dieser Arbeitsvertrag schließt sich dem mit der ',
                                    $('<span class="dynamic"/>').append(employee.Previous_Entity),
                                    ' am ',
                                    $('<span class="dynamic"/>').append(employee.Previous_Contract_Signature_Date.length && moment(employee.Previous_Contract_Signature_Date).locale('de').format('DD MMMM YYYY')),
                                    ...
                                    $('<mark/>').append(
                                        employee.Continuous_Service_Date && moment(employee.Continuous_Service_Date).locale('de').format('DD MMMM YYYY')
                                    ),
                                    ' gilt.'
                                ),
                                (employee.Entity_Transfer != 'Yes') && 
                                ...
                                (employee.Continuous_Service != 'Yes') && resetFooterSpaces(),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                                (employee.Continuous_Service == 'Yes') &&
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Continuous Service Credit"/>').prop('id', makeid()).append(
                                ...
                                (employee.Continuous_Service == 'Yes') && decrementFooterSpaces(3),
                                (employee.Continuous_Service != 'Yes') &&
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Continuous Service Credit"/>').prop('id', makeid()).append(
                    ...
                    $('<li/>').append(
                        ...
                        $('<ul/>').append(
                            ...
                            $('<div/>').append(
                                $('<div/>').html(
                                    '3.2. Der Mitarbeiter verpflichtet sich, im Rahmen des gesetzlich Zulässigen vorübergehend in zumutbarem Maß Überstunden bzw. Mehrarbeit, auch an Samstagen, Sonn- und Feiertagen, zu leisten, wenn dies aus betrieblichen Gründen durch den Gesellschaft angeordnet wird.'
                                ),
                                $('<p/>').html('')
                            ),
                            ...
                            $('<div/>').append(
                                $('<div/>').html(
                                    '3.3. Etwaige Mehrarbeit ist durch das Grundgehalt vollumfänglich abgegolten.'
                                ),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                                $('<div/>').html(
                                    '3.4. Jegliche Sonderleistungen oder Sonderzahlungen, die nicht in diesem Vertrag oder einer anderen (gegebenenfalls auch mündlichen) vertraglichen Abrede ausdrücklich vereinbart sind, erfolgen freiwillig und ohne Rechtsanspruch für die Zukunft. Auch die wiederholte Gewährung begründet keinen Anspruch aus betrieblicher Übung.'
                                ),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                                $('<div/>').html(
                                    '3.5. Die Abtretung oder Verpfändung von Vergütungsansprüchen ist ausgeschlossen. Etwaige Vergütungsüberzahlungen sind an die Gesellschaft zurückzuerstatten. Die Gesellschaft ist zur Aufrechnung mit überzahlten Bezügen im Rahmen nachfolgender Gehaltszahlungen berechtigt. Der Einwand des Wegfalls der Bereicherung (§ 818 Abs. 3 BGB) ist ausgeschlossen.'
                                ),
                                $('<p/>').html('')
                            )
                        )
                    ...
                    $('<li/>').append(
                        ...
                        $('<ul/>').append(
                            $('<div/>').append(
                                (employee.Relocation == 'Y' && employee.Relo_Bonus == 'No') &&
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Employee Relocating"/>').prop('id', makeid()).append(
                                ...
                                (employee.Relocation == 'Y' && employee.Relo_Bonus == 'No') && decrementFooterSpaces(9),
                    ...
                    $('<li/>').append(
                        ...
                        $('<ul/>').append(
                            $('<div/>').append(
                                ...
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Qualifies for Hire On Bonus"/>').prop('id', makeid()).append(
                    ...
                    $('<li/>').append(
                        ...
                        $('<ul/>').append(
                            $('<div/>').append(
                                $('<div/>').html(
                                    '8.1. Der Mitarbeiter hat Anspruch auf einen bezahlten Erholungsurlaub von 30  Arbeitstagen (bei einer 5-Tage-Woche) pro Kalenderjahr. Der Urlaubsanspruch setzt sich aus dem gesetzlichen Urlaubsanspruch von 20 Arbeitstagen sowie einem darüber hinausgehenden vertraglichen Urlaubsanspruch von 10  Arbeitstagen pro Kalenderjahr zusammen. Für den gesetzlichen Mindesturlaub findet das Bundesurlaubsgesetz in seiner jeweils geltenden Fassung Anwendung. Der vertragliche Urlaubsanspruch wird im Jahr des Ein- und Austritts anteilig gewährt.'
                                ),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                            ...
                            $('<div/>').append(
                                $('<p/>').append(
                                    '8.3 Das Urlaubsjahr ist das Kalenderjahr. Der Mitarbeiter soll seinen gesamten Urlaubsanspruch innerhalb des Kalenderjahres in Anspruch nehmen.  Eine Übertragung des Urlaubs auf das nächste Kalenderjahr erfolgt nur, wenn dringende betriebliche oder in der Person des Mitarbeiters liegende Gründe dies rechtfertigen. Soweit der Mitarbeiter seinen Urlaub im laufenden Urlaubsjahr jedoch aufgrund dringender betrieblicher oder in der Person des Mitarbeiters liegender Gründe nicht in Anspruch nehmen kann, wird ein Resturlaubsanspruch im Rahmen der gesetzlichen Bestimmungen auf das Folgejahr übertragen und verfällt ersatzlos wenn er nicht bis zum 30. April des Folgejahres genommen wird. Abweichend davon gilt, dass ein übertragener gesetzlicher Urlaub noch bis zum 31.03. des zweiten Folgejahres fortbesteht, wenn und soweit der Mitarbeiter wegen andauernder Erkrankung den übertragenen gesetzlichen Urlaub nicht rechtzeitig innerhalb des Übertragungszeitraums nehmen kann.'
                                    
                                ),
                                $('<p/>').html('Die Gesellschaft ist nicht verpflichtet, den Mitarbeiter aufzufordern, vertraglichen Urlaub in Anspruch zu nehmen.'),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                                $('<div/>').html(
                    ...
                    $('<li/>').append(
                        ...
                        $('<ul/>').append(
                            $('<div/>').append(
                                (/^T/.test(employee.Employee_Group)) &&
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Employee Group is Temporary (Yes/No)"/>').prop('id', makeid()).append(
                                    '13.1. Das Arbeitsverhältnis beginnt wie vereinbart am ',
                                        $('<mark/>').append(
                                            employee.German_Event_Start_Date
                                        ),
                                        ...
                                        $('<mark/>').append(
                                            employee.ContractEndDate && moment(employee.ContractEndDate).locale('de').format('DD MMMM YYYY')
                                        ),
                            ...
                            $('<div/>').append(
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Contract Term Exception (Yes/No)"/>').prop('id', makeid()).append(
                                    '13.3. ',
                                    ...
                                    $('<span/>').append(
                                        (employee.Contract_Term_Exception == 'No') &&
                                        'Für die Kündigung des Arbeitsverhältnisses gilt eine Kündigungsfrist von drei Monaten zum Monatsende für beide Parteien als vereinbart.',
                                        (employee.Contract_Term_Exception == 'Yes') &&
                                        'Für die Kündigung des Arbeitsverhältnisses gelten die die gesetzlichen Kündigungsfristen (BGB) für beide Parteien als vereinbart.'
                                    )
                                ),
                                $('<p/>').html('')
                            ),
                            ...
                            $('<div/>').append(
                                (/^R/.test(employee.Employee_Group)) &&
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Employee Group is Regular (Yes/No)"/>').prop('id', makeid()).html(
                                    '13.6. Das Vertragsverhältnis endet ohne dass es einer Kündigung bedarf, spätestens mit Ablauf des Kalendermonats, in dem der Mitarbeiter die für ihn maßgebliche Altersgrenze für eine ungekürzte Regelaltersrente in der gesetzlichen Rentenversicherung (Regelaltersgrenze) oder, wenn der Mitarbeiter nicht Mitglied in der gesetzlichen Rentenversicherung bzw. von der Versicherungspflicht in der gesetzlichen Rentenversicherung befreit ist, eine vergleichbare Leistung einer Versicherungs- oder Versorgungseinrichtung erreicht, oder erstmalig eine vorgezogene Altersrente bezieht.'
                                ),
                                (!/^R/.test(employee.Employee_Group)) &&
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Employee Group is Regular (Yes/No)"/>').prop('id', makeid()).html(
                                    '13.6. Wird das Vertragsverhältnis über das Befristungsende hinweg fortgesetzt, endet dieses ohne dass es einer Kündigung bedarf, spätestens mit Ablauf des Kalendermonats, in dem der Mitarbeiter die für ihn maßgebliche Altersgrenze für eine Regelaltersrente (Regelaltersgrenze) oder, wenn der Mitarbeiter nicht Mitglied in der gesetzlichen Rentenversicherung (§ 35 SGB VI) bzw. von der Versicherungspflicht in der gesetzlichen Rentenversicherung befreit ist, eine vergleichbare Leistung einer Versicherungs- oder Versorgungseinrichtung erreicht, oder erstmalig eine vorgezogene Altersrente bezieht.'
                                ),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                                '13.7. Das Arbeitsverhältnis endet automatisch, ohne dass es einer Kündigung bedarf, mit Ablauf des Monats, in dem ein Bescheid zugestellt wird, mit dem der zuständige Sozialversicherungsträger feststellt, dass der Mitarbeiter auf Dauer berufs- oder erwerbsunfähig ist, bei späterem Beginn des entsprechenden Rentenbezugs jedoch erst mit Ablauf des dem Rentenbezug vorhergehenden Tages. Gewährt der Sozialversicherungsträger nur eine Rente auf Zeit, so ruht der Arbeitsvertrag für den Bewilligungszeitraum dieser Rente, längstens jedoch bis zum Beendigungszeitpunkt gemäß Satz 1 bzw. Ziffer 13.6.',
                                $('<p/>').html('')
                            )
                        )
                    ),
                    ...
                    $('<li/>').append(
                        $('<div/>').html(
                            '<strong>Aufenthaltserlaubnis zum Zwecke der Erwerbstätigkeit; auflösende Bedingung der Wirksamkeit des Arbeitsvertrages im Falle des Ablaufs oder sonstigen Entfalls</strong>'
                        ),
                        $('<p/>').html(''),
                        $('<ul/>').append(
                            $('<div/>').append(
                                $('<div/>').append(
                                    '14.1. Ist für die Beschäftigung des Mitarbeiters ein Aufenthaltstitel zum Zwecke der Erwerbstätigkeit in Deutschland erforderlich, steht die Wirksamkeit des Arbeitsvertrages unter der aufschiebenden Bedingung (§ 158 Abs. 1 BGB), dass der Nachweis eines gültigen Aufenthaltstitels für die beabsichtigte Tätigkeit bei der Gesellschaft vor Arbeitsbeginn vorgelegt wird. Die Wirksamkeit des Vertrages steht gleichsam unter der ',
                                    $('<strong/>').text('auflösenden Bedingung (§ 158 Abs. 2 BGB)'),
                                    ' des Ablaufs oder sonstigen Entfalls eines gültigen Aufenthaltstitels zum Zwecke der Erwerbstätigkeit für Deutschland.'
                                ),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                    ...
                    $('<li/>').append(
                        ...
                        $('<ul/>').append(
                            $('<div/>').append(
                                $('<div/>').html(
                                    '17.1. Sämtliche Ansprüche aus dem Arbeitsverhältnis und seiner Beendigung sind innerhalb einer Ausschlussfrist von drei Monaten nach Fälligkeit des Anspruches gegenüber der anderen Vertragspartei in Textform geltend zu machen. <br>Lehnt die Gegenseite den Anspruch ab oder erklärt sich nicht innerhalb von zwei Wochen nach der Geltendmachung des Anspruches, so verfällt dieser, wenn er nicht innerhalb von drei Monaten nach der Ablehnung oder nach erfolglosem Ablauf der 2-Wochen-Frist gerichtlich geltend gemacht wird.'
                                ),
                                $('<p/>').html(''),
                                $('<p/>').html(''),
                                $('<p/>').html('')
                            ...
                            $('<div/>').append(
                                $('<div/>').html(
                                    '17.2. Diese Ausschlussfristen gem. Ziff. 17.1 gelten nicht für Ansprüche aus unerlaubter Handlung, Ansprüche aus einer Haftung für vorsätzliches Verhalten, Ansprüche, die aus der Verletzung des Lebens, des Körpers oder der Gesundheit resultieren, sowie für auf Gesetz oder Rechtsverordnung beruhende Mindestlohn- und Mindestentgeltansprüche (z. B. nach dem Mindestlohngesetz) und sonstige gesetzliche Ansprüche, auf die die Arbeitsvertragsparteien nicht oder nicht ohne Beteiligung Dritter verzichten können.'
                                ),
                                $('<p/>').html('')
                            )
                        )
    ...
    $("#markup2").html("").append(
        ...
        $('<div class="offerClause2"/>').append(
            ...
            $('<p class="center"/>').html(
                $('<strong/>').append(
                    (/^T/.test(employee.Employee_Group)) && $('<mark/>').append(
                        'FIXED-TERM&nbsp;'
                    ),
                    'EMPLOYMENT CONTRACT'
                )
                ...
                $('<ol/>').append(
                    ...
                    $('<li/>').append(
                        ...
                        $('<ul/>').append(
                            $('<div/>').append(
                                $('<div/>').append(
                                    '1.1. The Employee shall be employed with the Company as of ',
                                    $('<mark/>').text(employee.Event_Start_Date),
                                    ', as ',
                                    $('<mark/>').text(employee.Business_Title),
                                    ' subject to the completion of a positive Background Check. He shall report to a supervisor/manager designated by the Company from time to time.'
                                ),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                                ...
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Transferring from another PP entity"/>').prop('id', makeid()).append(
                                    ...
                                    $('<mark/>').append(
                                        employee.Previous_Entity
                                    ),
                                    ' on ',
                                    $('<mark/>').append(
                                        employee.Previous_Contract_Signature_Date && moment(employee.Previous_Contract_Signature_Date).format('DD MMMM YYYY')
                                    ),
                                    ...
                                    $('<mark/>').append(
                                        employee.Continuous_Service_Date && moment(employee.Continuous_Service_Date ).format('DD MMMM YYYY')
                                    ),
                                    '.'
                                ),
                                (employee.Entity_Transfer != 'Yes') &&
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Transferring from another PP entity"/>').prop('id', makeid()).html(
                            ...
                            $('<div/>').append(
                                ...
                                (employee.Continuous_Service != 'Yes') &&
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Continuous Service Credit"/>').prop('id', makeid()).html(
                            ...
                            $('<div/>').append(
                                $('<div/>').html(
                                    '1.4. The ordinary termination of the employment contract is excluded prior to the commencement of the employment relationship.'
                                ),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                    ...
                    $('<li/>').append(
                        ...
                        $('<ul/>').append(
                            $('<div/>').append(
                                $('<div/>').append(
                                    '3.1.   The Company shall pay to the Employee an annual fixed gross salary of ',
                                    $('<mark/>').text(employee.Salary_Amount),
                                    ' ',
                                    $('<mark/>').text(employee.Salary_Currency),
                                    ', payable in twelve equal installments at the end of each calendar month subject to statutory deductions ("',
                                    $('<strong/>').text('Base Salary'),
                                    '").'
                                ),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                                '3.2.   The Employee agrees to temporarily work reasonable overtime hours respectively long hours in accordance with statutory law, also on Saturdays, Sundays, and public holidays, if ordered by the Company for operational reasons.',
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                                '3.3.   Any overtime work shall be fully compensated by the Base Salary.',
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                                '3.4.   Any gratifications or special benefits, which are not expressly provided for in this agreement or another written or oral agreement, are discretionary shall not constitute the basis of a legal claim for any future payments. Even repeated payment or grant does not give rise to a claim based on operational practice.',
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                                '3.5.   Remuneration claims may not be assigned and pledged or otherwise be encumbered. Any overpayments must be repaid. The Company may set off any overpayments against subsequent salary payments. The defense of loss of enrichment (Sec. 818 par. 3 German Civil Code) shall be excluded.',
                                $('<p/>').html('')
                            )
                        )
                    ),
                        ...
                        $('<ul/>').append(
                            $('<div/>').append(
                                ...
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Employee Relocating"/>').prop('id', makeid()).append(
                                    ...
                                    $('<mark/>').append(employee.Estimate_Relo_Cost),
                                    ' ',
                                    $('<mark/>').append(employee.Estimated_Relo_Cost_CRNCY_CD),
                                ...
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Employee Relocating"/>').prop('id', makeid()).html(
                    ...
                    $('<li/>').append(
                        ...
                        $('<ul/>').append(
                            $('<div/>').append(
                                (employee.Hire_on_Bonus_Eligible == 'Yes') &&
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Employee Eligible for Hire On Bonus"/>').prop('id', makeid()).append(
                                ...
                                (employee.Hire_on_Bonus_Eligible != 'Yes') &&
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Employee Eligible for Hire On Bonus"/>').prop('id', makeid()).html(
                                    'Not applicable to employee.'
                                ),
                                $('<p/>').html('')
                            )
                    ...
                    $('<li/>').append(
                        ...
                        $('<ul/>').append(
                            $('<div/>').append(
                                $('<div/>').html(
                                    '8.1.   The Employee shall be entitled to 30 working days (based on a 5-day working week) of paid vacation per calendar year. The vacation entitlement consists of the statutory vacation term of 20 work days and a contractually granted, additional vacation term of 10  workdays per calendar year. For the minimum statutory leave the latest version of the Federal Holiday Act shall apply. In the year of the Employee’s entering or leaving the Company the contractual additional vacation shall be granted on a pro-rata basis.'
                                ),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                            ...
                            $('<div/>').append(
                                $('<div/>').html(
                                    '8.3.   The vacation year is the calendar year. The employee shall use up his vacation entitlement within the given calendar year.  A carry-over of vacation entitlement to the following calendar year is only permissible if this is justified by urgent reasons related to the business unit of the Company, or by urgent personal reasons of the Employee. To the extent that the Employee cannot take his vacation during any calendar year due to compelling business reasons or reasons in the person of the Employee, any remaining vacation claim shall be transferred to the following calendar year in accordance with applicable law and shall be cancelled without compensation if not taken by April 30 of the following calendar year. However, any statutory vacation carried over may be used until 31 March of the second following year if and to the extent that the Employee was unable to use the vacation in time during the carryover period due to permanent illness. The Company is not obliged to ask the Employee to take the additional contractual vacation.'
                                ),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                    ...
                    $('<li/>').append(
                        ...
                        $('<ul/>').append(
                            ...
                            $('<div/>').append(
                                $('<div/>').html(
                                    '9.3. This applies likewise to any activities as a managing director or as a member of the management board or supervisory board of other companies.'
                                ),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                        ...
                        $('<ul/>').append(
                            $('<div/>').append(
                                ...
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Employee Group is Temporary (Yes/No)"/>').prop('id', makeid()).append(
                                    ...
                                    $('<mark/>').append(employee.Event_Start_Date),
                                    ' and has a fixed term of ',
                                    $('<mark/>').append(employee.FTELength),
                                    ' months. The employment terminates, automatically, without a termination being required, on ',
                                    $('<mark/>').append(moment(employee.ContractEndDate).format('DD MMMM YYYY')),
                                    '.'
                                ),
                                (!/^T/.test(employee.Employee_Group)) &&
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Employee Group is Temporary (Yes/No)"/>').prop('id', makeid()).append(
                                ...
                                $('<p/>').html(''),
                                (employee.ProbationPeriodRequired == 'yes') &&
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Probation Period Required"/>').prop('id', makeid()).html(
                            ...
                            $('<div/>').append(
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Contract Term Exception (Yes/No)"/>').prop('id', makeid()).append(
                                    ...
                                    $('<span/>').append(
                                        (employee.Contract_Term_Exception == 'No') &&
                                        'After expiration of the probationary period, the employment agreement can be terminated by either party by giving three months\' notice effective to the end of a calendar month.',
                                        (employee.Contract_Term_Exception == 'Yes') &&
                                        'After expiration of the probationary period, the employment agreement can be terminated by either party by giving legal period of notice (acc. to BGB).'
                                    ),
                                    (employee.Continuous_Service == 'No' || employee.ProbationPeriodRequired == 'yes') &&
                                    $('<p/>').html(''),
                                    (employee.Continuous_Service == 'Yes' || employee.ProbationPeriodRequired == 'no') &&
                                    $('<span/>').append(
                                        (employee.Contract_Term_Exception == 'No') &&
                                        'The employment agreement can be terminated by either party by giving three months\' notice effective to the end of a calendar month.',
                                        (employee.Contract_Term_Exception == 'Yes') &&
                                        'The employment agreement can be terminated by either party by giving legal period of notice (statutory periods acc. to BGB).'
                                    )
                                ),
                                $('<p/>').html('')
                            ),
                            ...
                            $('<div/>').append(
                                $('<div class="marked" data-toggle="popover" data-placement="top" data-content="Employee Group is Regular (Yes/No)"/>').prop('id', makeid()).append(
                                    '13.6. ',
                                    (/^R/.test(employee.Employee_Group)) &&
                                    'The employment agreement shall terminate automatically without notice required at the latest at the end of the calendar  month in which the Employee reaches the regular pension age for an unrestricted old-age pension in  the statutory pension insurance or, if the Employee is not a member of the statutory pension insurance or is exempted from compulsory insurance in the statutory pension insurance if he reaches the statutory retirement age for a comparable pension from an insurance or pension institution, or receives an early old age pension.',
                                    (!/^R/.test(employee.Employee_Group)) &&
                                    'In case the parties continue their cooperation based on this contract also after the expiration of the fixed term, the employment agreement shall terminate automatically without notice required at the latest at the end of the calendar the month in which the Employee reaches the regular pension age for an unrestricted old-age in the statutory pension insurance (Sec. 35 Social Security Act, Part VI) or, if the Employee is not a member of the statutory pension insurance or is exempted from compulsory insurance in the statutory pension insurance if he reaches the statutory retirement age for a comparable pension from an insurance or pension institution, or receives an early old age pension.'
                                ),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                                '13.7. The employment terminates automatically, without need for notice, at the end of the month in which a decision is served in which the competent social security authority confirms that the Employee is permanently disabled or incapacitated, however; if pension is received at a later date employment terminates at the end of the day preceding the day on which the Employee begins to receive pension. If the social security authority only grants pension on a temporary basis the employment is dormant for the duration of the granting of the pension, at the longest, however, until the termination date pursuant to sentence 1 and/or clause 13.6.',
                                $('<p/>').html('')
                            )
                        )
                    ),
                    ...
                    $('<li/>').append(
                        $('<div/>').html(
                            '<strong>Residency permit for the Purpose of Employment; Ineffectiveness of the Employment Contract in Case of the Expiry or other Cancellation</strong>'
                        ),
                        $('<p/>').html(''),
                        $('<ul/>').append(
                            $('<div/>').append(
                                $('<div/>').append(
                                    '14.1.  If a residency permit for the purpose of employment in Germany is required for the engagement of the Employee, the validity of this Employment Contract is subject to the condition precedent (Sec. 158 para 1 German Civil Code - ',
                                    $('<em/>').append('“BGB”'),
                                    ') that proof of such a valid residency permit for the Employee\'s occupation under this Contract is presented to the Company prior to the start date. Likewise, this Employment Contract ',
                                    $('<strong/>').append('shall become ineffective'),
                                    ' based on the condition precedent of the expiry or other cancellation of a valid residence permit for the purpose of employment ',
                                    $('<strong/>').append('(Sec. 158 para 2 BGB).')
                                ),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                    ...
                    $('<li/>').append(
                        ...
                        $('<ul/>').append(
                            $('<div/>').append(
                                $('<div/>').html(
                                    '17.1. All reciprocal claims resulting from this contract and the employment relationship are forfeited if they have not been asserted against the other party in text form within three months after their due date. If the opposing party denies the claim or if it does not specify its position within two weeks after assertion of the claim the claim is forfeited unless it is being enforced in court within three months following the denial or the expiration of the two weeks period.'
                                ),
                                $('<p/>').html('')
                            ),
                            $('<div/>').append(
                                $('<div/>').html(
                                    '17.2. The preclusion periods according to Section 17.1 do not apply to claims for tort, claims resulting from injury to life, body or health liability claims, claims due to intent, statutory minimum wage claims (e.g. according to the Minimum Wage Act (Mindestlohngesetz – MiLoG)) and other legal claims which the parties to the contract cannot or may not waive without the participation of third parties.'
                                ),
                                $('<p/>').html('')
                            )
                        )
