...
document.onreadystatechange = function() {
    // turn required indicator on/off
    const toggleRequiredIndicator = function(controller, dependents) {
        'use strict'
    ...
    const toggleDependents = document.querySelectorAll('[name$=".Nom_de_la_voie"], [name$=".Code_postal"], [name$=".Bureau_distributeur"], [name$=".No_INSEE_commune"]')
    ...
    estrangerCountry.addEventListener('change', function(e) {
        toggleRequiredIndicator(e.target, toggleDependents)
    })
    // toggle indicator on load
    toggleRequiredIndicator(estrangerCountry, toggleDependents)
