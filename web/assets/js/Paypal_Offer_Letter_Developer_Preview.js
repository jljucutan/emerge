/**
 * CHANGE LOGS
 * 02/19/2020| jjucutan | template development for print
 */
...
const fnView = function() {
    ...
    markupRoot.append(
        ...
        $('<div class="offerClause">').append(
            ...
            (OfferLetterData.Exempt_Code === "E" && OfferLetterData.JobType === "Full Time") && $('<p class="marked" data-toggle="popover" data-content="Full Time Exempt Employee"/>').append(
            ...
            (OfferLetterData.Exempt_Code === "N" && OfferLetterData.JobType === "Full Time") && $('<p class="marked" data-toggle="popover" data-content="Full Time Non-Exempt Employee"/>').append(
            ...
            (OfferLetterData.Exempt_Code === "E" && OfferLetterData.JobType === "Part Time") && $('<p class="marked" data-toggle="popover" data-content="Part Time Exempt Employee"/>').append(
            ...
            (OfferLetterData.Exempt_Code === "N" && OfferLetterData.JobType === "Part Time") && $('<p class="marked" data-toggle="popover" data-content="Part Time Non-Exempt Employee"/>').append(
                'At PayPal, we pride ourselves in offering a competitive total rewards package.  Your hourly rate of pay will be ',
                $('<mark/>').append(
                    OfferLetterData.SalaryOffered
                ),
            ...
            (OfferLetterData.SHIFT_DIFFERENTIAL.length > 0) && $('<p class="marked" data-toggle="popover" data-content="Qualifies for Shift Differential"/>').append(
            ...
            (OfferLetterData.Shift_Differential_Exempt.length > 0) && $('<p class="marked" data-toggle="popover" data-content="Qualifies for Shift Differential Exempt"/>').append(
            ...
            (OfferLetterData.LANGUAGE_DIFFERENTIAL.length > 0) && $('<p class="marked" data-toggle="popover" data-content="Qualifies for Language Differential"/>').append(
                'You will be eligible for a ',
                $('<mark/>').append(
            ...
            (OfferLetterData.eIP_Target_Pct > 0) && $('<p class="marked" data-toggle="popover" data-content="Qualifies for Annual Incentive Plan (AIP)"/>').append(
            ...
            (OfferLetterData.SalesTargetDollarAmt.length > 0) && $('<p class="marked" data-toggle="popover" data-content="Qualifies for Sales Incentive Plan"/>').append(
                ...
                '.   Details of the plan will be provided to you by your manager.  The payment of any incentive is at PayPal’s sole and absolute discretion and subject to the terms and conditions of the plan.  PayPal reserves the right, in its sole discretion, to amend, change or cancel the plan at any time.'
            ),
            (OfferLetterData.EntityName !== "Swift" && OfferLetterData.Sales_Commission_Eligible === "Yes") && $('<p class="marked" data-toggle="popover" data-content="Qualifies for Sales Commission Plan"/>').append(
            ...
            (OfferLetterData.Credit_Incentive_Plan_Eligible === "no" && OfferLetterData.EntityName === "Swift" && OfferLetterData.Sales_Commission_Eligible === "Yes") && $('<p class="marked" data-toggle="popover" data-content="Qualifies for Sales Commission Plan (Swift Employee)"/>').append(
            ...
            (OfferLetterData.EntityName === "Swift" && OfferLetterData.Credit_Incentive_Plan_Eligible === "yes") && $('<p class="marked" data-toggle="popover" data-content="Qualifies for Credit Incentive Plan (Swift)"/>').append(
            ...
            (OfferLetterData.CSIncentivePlan.length > 0) && $('<p class="marked" data-toggle="popover" data-content="Qualifies for CS Incentive Plan"/>').append(
                'There’s more, of course.  You are also eligible to participate in an incentive plan based on individual achievement and/or other group performance measures.   Your target incentive is ',
                $('<mark/>').append(
                    OfferLetterData.CSIncentivePlan
                ),
                '% of your eligible earnings.  Details of the plan will be provided to you by your manager.   The payment of any incentive is at PayPal’s sole and absolute discretion and subject to the terms and conditions of the plan.   PayPal reserves the right, in its sole discretion, to amend, change or cancel the plan at any time.'
            ),
            (OfferLetterData.CSIncentivePlan_fixed.length > 0) && $('<p class="marked" data-toggle="popover" data-content="Qualifies for CS Incentive Plan (Fixed)"/>').append(
                'There’s more, of course.  You are also eligible to participate in an incentive plan based on individual achievement and/or other group performance measures.   Details of the plan will be provided to you by your manager.   The payment of any incentive is at PayPal’s sole and absolute discretion and subject to the terms and conditions of the plan.   PayPal reserves the right, in its sole discretion, to amend, change or cancel the plan at any time.'
            ),
            (OfferLetterData.Front_Office_Metrics_Plan.length > 0) && $('<p class="marked" data-toggle="popover" data-content="Qualifies for Front Office Metrics Plan"/>').append(
                'There’s more, of course.  You are also eligible to participate in an incentive plan starting on the first of the quarter following 9 months of employment based on individual achievement and/or other group performance measures.   Your target incentive is ',
                $('<mark/>').append(
                    OfferLetterData.Front_Office_Metrics_Plan
                ),
                '% of your eligible earnings.  Details of the plan will be provided to you by your manager.   The payment of any incentive is at PayPal’s sole and absolute discretion and subject to the terms and conditions of the plan.   PayPal reserves the right, in its sole discretion, to amend, change or cancel the plan at any time.'
            ),
            (OfferLetterData.Back_Office_Individual_Performance_Plan.length > 0) && $('<p class="marked" data-toggle="popover" data-content="Qualifies for Back Office Metrics Plan"/>').append(
                'There’s more, of course.  You are also eligible to participate in an incentive plan starting on the earlier of January 1 or July 1 to occur following 6 months of employment based on individual achievement and/or other group performance measures.   Your target incentive is ',
                $('<mark/>').append(
                    OfferLetterData.Back_Office_Individual_Performance_Plan
                ),
                '% of your eligible earnings.  Details of the plan will be provided to you by your manager.   The payment of any incentive is at PayPal’s sole and absolute discretion and subject to the terms and conditions of the plan.   PayPal reserves the right, in its sole discretion, to amend, change or cancel the plan at any time.'
            ),
(OfferLetterData.EVENT_REPAYMENT_FLAG !== "No" || OfferLetterData.paymentAmount1.length > 0 || OfferLetterData.paymentAmount2.length > 0 || OfferLetterData.Option2PaymentAmt.length > 0 ) && $('<div class="marked" data-toggle="popover" data-content="Qualifies for Hire-On Bonus"/>').append(
                'In addition, PayPal is offering you the following:'
                        ),

            (OfferLetterData.EVENT_REPAYMENT_FLAG == "Hire on Greater than 50% of base salary" || OfferLetterData.EVENT_REPAYMENT_FLAG == "Hire on less than 50% of base salary") && $('<div class="marked" data-toggle="popover" data-content="Qualifies for One-time Sign On Bonus"/>').append(
            ...
            (OfferLetterData.paymentAmount1.length > 0) && $('<div class="marked" data-toggle="popover" data-content="Qualifies for One-time Make Good Bonus"/>').append(
                $('<ul class="list-indented"/>').append(
                    $('<li/>').append(
            ...
            (OfferLetterData.paymentAmount2.length > 0) && $('<div class="marked" data-toggle="popover" data-content="Qualifies for One-time Make Good Bonus 1"/>').append(
                $('<ul class="list-indented"/>').append(
                    $('<li/>').append(
                        'A one-time make-good bonus of ',
                        $('<mark/>').append(
            ...
            (OfferLetterData.Option2PaymentAmt.length > 0) && $('<div class="marked" data-toggle="popover" data-content="Qualifies for One-time Make Good Bonus 2"/>').append(
                $('<ul class="list-indented"/>').append(
                    $('<li/>').append(
                        'A one-time make-good bonus of ',
                        $('<mark/>').append(
            ...
            (OfferLetterData.EVENT_REPAYMENT_FLAG !== "No") && $('<div class="marked" data-toggle="popover" data-content="Requires Repayment Agreement"/>').append(
                  $('<p/>').append(
            ...
            (OfferLetterData.NEW_HIRE_REST_STOCK_UNITS.length > 0) && $('<div class="marked" data-toggle="popover" data-content="Qualifies for Restricted Stock Units (RSUs)"/>').append(
                $('<p/>').append(
                ...
                (OfferLetterData.SupplementalRSU.length > 0) && $('<div class="marked" data-toggle="popover" data-content="Qualifies for Supplemental Restricted Stock Unit Award"/>').append(
                    '<hr class="HRblack">',
                    $('<p/>').append(
                        $('<strong/>').append(
                            'Grant'
            ...
            (OfferLetterData.Relocation === "Y")  && $('<p class="marked" data-toggle="popover" data-content="Employee Relocating"/>').append(
            ...
            (OfferLetterData.Immigration === "Yes") && $('<p class="marked" data-toggle="popover" data-content="Non-US Citizen"/>').append(
