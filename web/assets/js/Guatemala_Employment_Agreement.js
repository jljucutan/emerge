...
function fnView() {
    $("#markup").html("").append(
        ...
        $('<div class="offerClause">').append(
            $('<p class="mb-60"/>').append(
                $('<span/>').append(GEAOfferLetter.employee.Full_Name + '<br>'),
                ...
                $('<span/>').append(GEAOfferLetter.employee.Zip ? GEAOfferLetter.employee.Zip + '<br>' : '')
            )
        ),
        $('<div class="offerClause" />').append(
            $('<p class="hide"/>').append('&nbsp;'),
            $('<p class="hide"/>').append('&nbsp;'),
            $('<p/>').text('CONTRATO DE TRABAJO INDIVIDUAL POR TIEMPO INDEFINIDO')
        ),
        $('<div class="offerClause" />').append(
        ...
        $('<div class="offerClause" />').append(
            $('<ul class="outer-list"/>').append(
                $('<li/>').append('<strong>(a)</strong> SOLUCIONES  BK, SOCIEDAD  ANÓNIMA representada aquí por Juan  José  ALVARADO, único director y representante, en lo sucesivo denominado “el Empleador”, <strong>de la primera parte</strong>,<p class="hide">&nbsp;</p>'),
                $('<li/>').append('<strong>(b)</strong> ' + GEAOfferLetter.employee.Full_Name + ', en lo sucesivo denominado “el Empleado”, <strong>de la segunda parte</strong>.')
            ),
            $('<p class="hide"/>').text('&nbsp;')
        ),
        $('<div class="offerClause" />').append(
            ...
            $('<ul class="mb-20 outer-list" />').append(
                ...
                $('<li/>').append(
                    ...
                    $('<ul class="list-indented"/>').append(
                        ...
                        $('<li/>').html('Si posteriormente el Empleado tiene en su posesión cualquier objeto de valor, información o documento mencionado antes propiedad del Empleador, deberá entregarlo en un plazo de tres días. ', $('<p class="hide"/>').append('&nbsp;'))
                    ),
                    $('<p class="hide"/>').append('&nbsp;')
                ),
                $('<li/>').append('<strong>(w)</strong> El Empleado declara que el sueldo acordado en el presente es reconocimiento suficiente para aceptar y estar de acuerdo con todas las funciones y responsabilidades del mismo.<br>')
            ),
            $('<p class="hide"/>').append('&nbsp;')
        ),
        $('<div class="offerClause" />').append(
            ...
            $('<p/>').append(
                $('<strong/>').append('CINCO. Horas de trabajo normales:<br>'),
                'Como el Empleado es un representante del Empleador o un Empleado de confianza, el Empleado no está sujeto a límites de horarios y trabajará por lo menos las horas básicas semanales generalmente establecidas para los Empleados administrativos normales, las cuales no excederán el límite máximo establecido en el Artículo 124 del Código de Trabajo, y las normas del presente documento. Las horas de trabajo podrán variar según las necesidades del trabajo.  El Empleado tendrá una hora de almuerzo, que no se computará como tiempo de trabajo real.  El día libre semanal puede darse cualquier día de la semana. Queda expresamente convenido que el Empleado deberá trabajar cualquier día libre semanal o día festivo, según lo determine el Empleador en conformidad con la ley.   Estas horas de trabajo pueden ser modificadas por el Empleador según sus necesidades y las del trabajo, y esto no significa ningún cambio en las condiciones de trabajo, como queda expresamente convenido.'
            ),
            $('<p/>').append(
    ...
    $("#markup3").html("").append(
        ...
        $('<div class="offerClause3">').append(
            $('<p class="hide"/>').append('&nbsp;'),
            $('<p/>').text(
                'INDEFINITE INDIVIDUAL EMPLOYMENT AGREEMENT'
            ),
            $('<p/>').text(
            ...
            $('<p class="hide"/>').text('&nbsp;'),
            $('<ul class="outer-list"/>').append(
                $('<li/>').append('<strong>(a)</strong> SOLUCIONES  BK, SOCIEDAD  ANONIMA represented herein by Juan  Jos&eacute;  ALVARADO, Sole Director and Representative, hereinafter referred to as “the Employer”, <strong>of the first part</strong>,<p class="hide">&nbsp;</p>'),
                $('<li/>').append('<strong>(b)</strong> ' + GEAOfferLetter.employee.Full_Name + ', hereinafter referred to as “the Employee”, <strong>of the second part</strong>.')
            ),
            $('<p class="hide"/>').append('&nbsp;'),
            $('<p/>').text(
            ...
            $('<ul class="mb-20 outer-list" />').append(
                ...
                $('<li/>').append(
                    '<strong>(w)</strong> The Employee declares that the salary agreed herein is sufficient recognition to accept and agree with all the roles and responsibilities accepted herein.<br>'
                )
            ),
            $('<p class="hide"/>').append('&nbsp;'),
            $('<p/>').append(
