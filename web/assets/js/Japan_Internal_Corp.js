...
function fnView() {
    ...
    $("#markup").html("").append(
        ...
        $('<div class="offerClause"/>').append(
            ...
            $('<div/>').append(
				$('<p/>').html(
					'Apple Japan, Inc. (’Apple’) is delighted to offer you the position of ' + employee.Job_Title + ' and the job level of ' + employee.Job_Level + '. In your new position you will report to ' + employee.Hiring_Manager + ' and your place of work will be Roppongi Hills, 6-10-1, Roppongi, Minato-ku, Tokyo. These conditions may be subject to change at the Apple’s discretion.'
				),
				$('<p/>').html(
					'Apple Japan合同会社(以下「Apple」といいます)は、あなたを' + employee.Job_Level + 'の、' + employee.Job_Title + 'のポジションで採用させていただきたく、お知らせ致します。この新たなポジションでは、' + employee.Hiring_Manager + 'があなたの上司となり、勤務地は東京都港区六本木6-10-1 六本木ヒルズとなります。ここに記載する条件は、Appleの裁量で変更する場合があります。'
				)
            ),
            // Work Location == YTC
            ...
            $('<div/>').append(
				...
				$('<p/>').html(
					'Apple Japan合同会社(以下「Apple」といいます)は、あなたを' + employee.Job_Level + 'の、' + employee.Job_Title + 'のポジションで採用させていただきたく、お知らせ致します。この新たなポジションでは、' + employee.Hiring_Manager + 'があなたの上司となり、勤務地は神奈川県横浜市港北区綱島東4-3-1 Apple Japan YTCとなります。ここに記載する条件は、Appleの裁量で変更する場合があります。'
				)
            ),
            ...
            $('<p/>').html(
                'Apple Japan合同会社(以下「Apple」といいます)は、あなたを' + employee.Job_Level + 'の、' + employee.Job_Title + 'のポジションで採用させていただきたく、お知らせ致します。この新たなポジションでは、' + employee.Hiring_Manager + 'があなたの上司となり、就労場所はあなたの自宅又はあなたが署名したApple-At-Home Advisor Program 契約(以下、「AHA契約」といいます)に基づきAppleが随時指定する研修場所となります。ここに記載する条件は、Appleの裁量で変更する場合があります。'
            )
            ),
            ...
            $('<p/>').html(
                'Apple Japan合同会社(以下「Apple」といいます)は、あなたを' + employee.Job_Level + 'の、' + employee.Job_Title + 'のポジションで採用させていただきたく、お知らせ致します。この新たなポジションでは、' + employee.Hiring_Manager + 'があなたの上司となり、就労場所はあなたの自宅又はあなたが署名したRCC At-Home Specialist Program 契約(以下、「AHS契約」といいます)に基づきAppleが随時指定する研修場所となります。ここに記載する条件は、Appleの裁量で変更する場合があります。'
            )
            ),
            ...
            $('<div/>').append(
				...
				$('<p/>').html(
					'Apple Japan合同会社(以下「Apple」といいます)は、あなたを' + employee.Job_Level + 'の、' + employee.Job_Title + 'のポジションで採用させていただきたく、お知らせ致します。この新たなポジションでは、' + employee.Hiring_Manager + 'があなたの上司となり、勤務地は入社にあたり指定するAppleショップならびにその他のApple製品取扱店となります。ここに記載する条件は、Appleの裁量で変更する場合があります。'
				)
            ),
            ...
            $('<div/>').append(
				...
				$('<p/>').html(
					'iTunes 株式会社(以下、「Apple」といいます)は、' + employee.Job_Level + 'の、' + employee.Job_Title + 'のポジションで採用させていただきたく、お知らせ致します。この新たなポジションでは、' + employee.Hiring_Manager + 'があなたの上司となり、勤務地は東京都港区六本木6-10-1 六本木ヒルズとなります。ここに記載する条件は、Appleの裁量で変更することがあります。'
				)
            ...
            $('<div/>').append(
				$('<p/>').html(
					'Apple Japan, Inc. (’Apple’) is delighted to offer you the position of ' + employee.Job_Title + ' with the job level of ' + employee.Job_Level + '. In your new position you will report to ' + employee.Hiring_Manager + ', at Apple Store, ' + employee.Work_Location_Retail + '. These conditions may be subject to change at the Apple’s discretion.'
				),
				$('<p/>').html(
					'Apple Japan 合同会社（以下「Apple」といいます）は、 あなたをアップルストア' + employee.Work_Location + '店にて' + employee.Job_Level + 'の、' + employee.Job_Title + 'のポジションで採用させていただきたく、お知らせ致します。この新たなポジションでは、' + employee.Hiring_Manager + 'があなたの上司となります。ここに記載する条件は、Apple の裁量で変更する場合があります。'
				)
            ),
...
(employee.JP_OT_Compensation == 'OT-Exempt') &&
            ...
            // Discretionary Bonus 
           ((employee.Job_Level_Code == 'MGR 3' || employee.Job_Level_Code == 'MGR 2' || employee.Job_Level_Code == 'MGR 1' || employee.Job_Level_Code == 'ICT 6' || employee.Job_Level_Code == 'IC 6' || employee.Job_Level_Code == 'ICT 5' || employee.Job_Level_Code == 'IC 5' || employee.Job_Level_Code == 'ICT 4' || employee.Job_Level_Code == 'IC 4' || employee.Job_Level_Code == 'ICT 3' || employee.Job_Level_Code == 'IC 3' || employee.Job_Level_Code == 'SUP' || employee.Job_Level_Code == 'SUP 2') && (employee.Offer_Type != 'DC AHA' && employee.Offer_Type != 'DC ASC' && employee.Offer_Type != 'Fixed Term General')) && (employee.Target == '') &&
            $('<div/>').append(
