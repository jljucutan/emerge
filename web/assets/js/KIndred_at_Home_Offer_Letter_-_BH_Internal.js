// Kindred At Home Offer Letter - BH Internal
// Copied from Kindred at Home Offer Letter 20210219
function fnView() {
  $("#markup").html("").append(
 ...
 $('<div class="offerClause"/>').append(
  ...
  (['Non-Exempt Per Diem Weekly -Hourly or  Non-Exempt Per Diem Bi-weekly - Hourly  or Non-Exempt Per Diem Bi-weekly - Visits'].indexOf(employee.Job_Custom_Field1) < 0 && employee.Position_Type == 'Part-Time') &&
  $('<div class="offerClause marked" data-toggle="popover" data-placement="top" data-content="Employee Class = a Per Diem position"/>').append(
    $('<p/>').append(
  ...
  $('<div class="offerClause marked" data-toggle="popover" data-placement="top" data-content="Employee Class = Exempt Bi-Weekly Clinical and Job Code = 09701236 or Job Code = 09701301 & Excludes California"/>').append(
    ...
    $('<ul class="offer_UL"/>').append(
      $('<li/>').append(
        'Visit type: Med Administration - Performance Points: 1.00'
        ),
      $('<li/>').append(
        'Visit type: Subsequent Med Administration - Performance Points: 0.50'
        ),
      $('<li/>').append(
        'Visit type: Recert - Performance Points: 1.50'
        ),
      $('<li/>').append(
        'Visit type: Discharge - Performance Points: 1.50'
        ),
      $('<li/>').append(
  ...
  $('<div class="offerClause marked" data-toggle="popover" data-placement="top" data-content="Employee Class = Exempt Fee Based Pay and Work Location is not equal to California"/>').append(
    $('<p/>').html(
